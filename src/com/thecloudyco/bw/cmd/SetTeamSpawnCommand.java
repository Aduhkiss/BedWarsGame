...
//		}
		...
		Starter.getInstance().getConfig().set(pl.getWorld().getName() + ".spawnpoints." + generator + ".x", pl.getLocation().getX());
		Starter.getInstance().getConfig().set(pl.getWorld().getName() + ".spawnpoints." + generator + ".y", pl.getLocation().getY());
		Starter.getInstance().getConfig().set(pl.getWorld().getName() + ".spawnpoints." + generator + ".z", pl.getLocation().getZ());
